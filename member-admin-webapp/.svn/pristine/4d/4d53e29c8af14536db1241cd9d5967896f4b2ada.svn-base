...
Ext.define('Ext.ux.form.TimePickerField', {
	  ...
	  */
	  ...
	  setDisabled: function(h, m, s){
	  	this.hoursSpinner.setDisabled(h);
	  	this.minutesSpinner.setDisabled(m);
	  	this.secondsSpinner.setDisabled(s);
	  },
	  setMaxValue: function(h, m, s){
	  	this.hoursSpinner.setMaxValue(h);
	  	this.minutesSpinner.setMaxValue(m);
	  	this.secondsSpinner.setMaxValue(s);
	  },
	  setMinValue: function(h, m, s){
	  	this.hoursSpinner.setMinValue(h);
	  	this.minutesSpinner.setMinValue(m);
	  	this.secondsSpinner.setMinValue(s);
	  }
  });