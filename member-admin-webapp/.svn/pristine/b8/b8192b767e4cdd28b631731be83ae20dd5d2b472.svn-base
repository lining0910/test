 ...
 * 选择用户ctrl
 */
Ext.define('Taole.common.goodsAllChoose.controller.GoodsChooseCtrl', {
    extend: 'Ext.app.Controller',
    views: ['Taole.common.goodsAllChoose.view.GoodsChooseWindow'],
    refs: [
    {
    	 ref: 'window',
    ...
    init: function() {
    	if(Taole.common.goodsAllChoose.controller.GoodsChooseCtrl.isInit)return;
    	
    	Taole.common.goodsAllChoose.controller.GoodsChooseCtrl.isInit = true;
