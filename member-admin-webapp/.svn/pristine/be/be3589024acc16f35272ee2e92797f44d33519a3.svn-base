 ...
 * 商品出库
 */
Ext.define("Taole.goods.outOfStorageManager.view.GoodsLayOutWindow", {
	extend: 'Ext.Window',
	alias : 'widget.goodsLayOutWindow',
	layout: 'border',
	width: 850,
	height: 600,
	modal: true,
	...
	initComponent: function() {
		var store = Ext.create('Taole.goods.outOfStorageManager.store.GoodsLayOutStore',{
		});	
		this.items = [
		      		{//-----------------------------------------------表单
		    			xtype: 'form',
		    			...
		    			columns: [
		    				...
		    				{header: '出库数量', dataIndex: 'amount',editor:{xtype:'numberfield',minValue:1,}, align: 'center', width:150,}
		    			],
		    		    tbar : [
		    		    	{text:'选择出库商品',action:'add', pressed:true},'-',
