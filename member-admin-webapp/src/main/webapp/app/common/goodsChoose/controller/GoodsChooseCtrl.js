 ...
 * 选择用户ctrl
 */
Ext.define('Taole.common.goodsChoose.controller.GoodsChooseCtrl', {
    extend: 'Ext.app.Controller',
    views: ['Taole.common.goodsChoose.view.GoodsChooseWindow'],
    refs: [
    {
    	 ref: 'window',
    ...
    init: function() {
    	if(Taole.common.goodsChoose.controller.GoodsChooseCtrl.isInit)return;
    	
    	Taole.common.goodsChoose.controller.GoodsChooseCtrl.isInit = true;
