 ...
 * 商品入库管理
 */
Ext.define("Taole.goods.goodsWarehousing.view.GoodsWarehousingPanel", {
	extend: 'Ext.Panel',
    alias : 'widget.goodsWarehousingPanel',  
    frame: true,
    layout: {
        type: 'border',
        padding: 5
    ...
    initComponent: function() {
		var store = Ext.create('Taole.goods.goodsWarehousing.store.GoodsWarehousingStore',{
		});		
		this.items = [
		{//-----------------------------------------------表单
			xtype: 'form',
		   	...
		   	{//--------------------------------第1行
				...
				},
				{
					...
					store: Ext.create("Ext.data.Store",{
						autoLoad:true,
						fields:['value','name'],
						data:[{"name":"进货入库","value":1},{"name":"调拨入库","value":2}],
					}),
				},{
					fieldLabel: '操作人',
					xtype: 'textfield',
		    ...
		    tbar : [
		    	{text:'选择入库产品',action:'add', pressed:true}
		    ],
		    columnLines: true,
		    selModel:{
