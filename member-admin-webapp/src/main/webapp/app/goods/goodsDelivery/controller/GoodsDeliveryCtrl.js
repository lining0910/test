Ext.define('Taole.goods.goodsDelivery.controller.GoodsDeliveryCtrl', {
    extend: 'Ext.app.Controller',
    views: [
    	'Taole.goods.goodsDelivery.view.GoodsDeliveryPanel'
    ],
    refs: [
    {
    	 ref: 'form',
         selector: 'goodsDeliveryPanel>form'
    },
    {
    	 ref: 'grid',
         selector: 'goodsDeliveryPanel>grid'
    }
    ],
    init: function() {
    	this.control({
    		'goodsDeliveryPanel>grid button[action=add]': {//新增
    			click: function(){
    		...
    		'goodsDeliveryPanel button[action=confirm]': {//保存
    			click: function(){
