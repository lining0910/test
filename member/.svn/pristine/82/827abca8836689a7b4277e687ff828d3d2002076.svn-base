...
public class Update {
	@ApiModel(value = "修改商品信息请求参数")
	public static class GoodsInfoServiceUpdateReq {
	...
	@ApiModel(value = "修改商品信息返回参数")
	public static class GoodsInfoServiceUpdateResp {
