package com.taole.member.domain.param.UserBillApplyService;
...
public class Query {
	@ApiModel(value = "查询充值订单求参数")
	public static class UserBillApplyServiceQueryReq {
	...
	@ApiModel(value = "查询充值订单返回参数")
	public static class UserBillApplyServiceQueryResp {
