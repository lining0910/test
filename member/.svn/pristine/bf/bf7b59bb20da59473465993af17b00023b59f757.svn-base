...
public class BuyTicket {
	...
	public static class ShopGoodsApiBuyTicketReq {
		...
		@ApiModelProperty(value = "门票信息列表", required = true)
		private List<OrderTicket> tikets;
		...
		public List<OrderTicket> getTikets() {
			return tikets;
		}

		public void setTikets(List<OrderTicket> tikets) {
			this.tikets = tikets;
		}
	}
	
	@ApiModel(value = "订单门票信息")
	...
	public class ShopGoodsApiBuyTicketRsp {
