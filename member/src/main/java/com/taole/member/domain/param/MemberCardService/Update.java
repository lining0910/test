...
public class Update {
	@ApiModel(value = "会员卡修改请求参数")
	public static class MemberCardServiceUpdateReq {

		@ApiModelProperty(value = "姓名", example = "")
		private String name;

		@ApiModelProperty(value = "手机号", example = "765467i")
	...
	@ApiModel(value = "会员卡修改返回参数")
	public static class MemberCardServiceUpdateResp {
