...
public class InStore {
	@ApiModel(value = "商品入库请求参数")
	public static class GoodsBillDetailServiceInStoreReq {

		private List<GoodsValue> goodsValues;

		@ApiModelProperty(value = "入库单号", example = "98765432")
		...
		@ApiModelProperty(value = "入库备注", example = "商品入库")
	...
	@ApiModel(value = "商品入库返回参数")
	public static class GoodsBillDetailServiceStoreResp {
