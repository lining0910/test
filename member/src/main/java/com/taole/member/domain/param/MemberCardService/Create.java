...
public class Create {
	@ApiModel(value = "会员办卡请求参数")
	public static class MemberCardServiceCreateReq {

		@ApiModelProperty(value = "经办人", example = "zhansan")
	...
	@ApiModel(value = "会员办卡返回参数")
	public static class MemberCardServiceCreateResp {
